...
using System.Data;
using System.Linq;
using MyRepository = RedisTest.Administration.Repositories.UserPermissionRepository;
using MyRow = RedisTest.Administration.UserPermissionRow;

namespace RedisTest.Administration.Endpoints
{
